...
%\begin{figure}[htp]
%	\centering
%	\includegraphics[width=100pt]{dino1.jpg}
%	\includegraphics[width=100pt]{dino2.jpg}
%	\includegraphics[width=100pt]{kaktus.jpg}
%	\caption{Obrázky s jedním návěštím}
%	\label{obr:jednoNavesti}
%\end{figure}
